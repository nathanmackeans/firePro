    ...
    <footer className="bg-navy-dark relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-1">
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative -top-20 bg-gradient-to-r from-fire-red to-fire-orange rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6"
        >
